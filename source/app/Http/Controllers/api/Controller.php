...
class Controller extends BaseController
{
    ...
    {
        return CoreResponse::responContinue($data, $statusCode);
    }
    ...
    {
        return CoreResponse::responSusscess($data, $statusCode);
    }
    ...
    {
        return CoreResponse::responWarning($data, $statusCode);
    }
    ...
    {
        return CoreResponse::responFail($data, $statusCode);
    }
}
